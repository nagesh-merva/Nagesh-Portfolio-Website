...
function MainSection() {
    ...
    return (
        <div>
                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 items-end pb-2 md:pb-8 z-10">
                        ...
                        >
                            <button
                                ...
                                className="text-xs sm:text-sm font-medium text-black flex items-center gap-2 hover:opacity-70 transition-opacity"
                            >
                                SCROLL TO SEE HOW
            ...
            <div id="intro" className="relative bg-white py-12 md:py-24 px-8 md:px-16">
                <div className="max-w-7xl mx-auto">
                    <div className="relative text-center mb-16 w-fit mx-auto">
